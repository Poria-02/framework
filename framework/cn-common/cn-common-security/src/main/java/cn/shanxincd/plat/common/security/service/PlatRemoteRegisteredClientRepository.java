...
public class PlatRemoteRegisteredClientRepository implements RegisteredClientRepository {
	...
	public RegisteredClient findByClientId(String clientId) {
		SysOauthClientDetails clientDetails = RetOps.of(SpringContextHolder.getBean(RemoteClientDetailsService.class).getClientDetailsById(clientId)).getData()

...
package cn.shanxincd.plat.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public PlatUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof PlatUser) {
			return (PlatUser) principal;
		}
		return null;
	}

	public String getSId(){
		PlatUser platUser =  getUser();
